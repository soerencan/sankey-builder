...
// No import from features/diagram/colors.ts in this file — palette.ts (unlike features/diagram/colors.ts) is
// d3-free at both module-eval and call time, same as platform/storage.ts which
// depends on that.
